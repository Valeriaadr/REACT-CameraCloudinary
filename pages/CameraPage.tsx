...
export default function CameraPage() {
  ...
  async function uploadImageToCloudinarySDK(uri: String) {
    const cld = new Cloudinary({
      cloud: {
        cloudName: "dcwxzdzh8", //cuenta
        apiKey: "995418368173557", //key
        apiSecret: "tVID-UO58s5n8WaWdD7aEBzQSDA",//Secretkey
    ...
    const options: UploadApiOptions = {
      upload_preset: "ml_default",  //nombre del preset
      public_id: "V123",   //id
    };
  ...
  async function uploadImageToCloudinaryRaw(base64){
    ...
    const response = await fetch("https://api.cloudinary.com/v1_1/dcwxzdzh8/image/upload", {
      method: "POST",
      body: formData,
    }).then((res) => res.json())
    .catch((err)=> err)
